...
document.write("<div style='position:absolute; left:100px; top:100px; width:250px; z-index:2000; background-color:#ffffff; border:solid 1px #dcdcdc;display:none;' id='MessBox2x'>");
document.write("	<div style=' padding:0px; cursor:move;height:26px' onmousedown='drag(this.parentNode, event);'>");
document.write("	<TABLE width=100% cellpadding=5 cellspacing=0 style='background:url(/images/index5_31.jpg) repeat-x;' border=0 height=26px>");
document.write("	<TR >");
document.write("		<TD align=left>&nbsp;&nbsp;<font style='font-family:microsoft yahei;color:#000000;font-size:12px' id='MessTitleID2x'></font></TD>");
document.write("		<TD align=right style='padding-top:5px'><a href='javascript:CloseMess2();'><img src=/images/shengqing2_03.jpg border=0 style='cursor:pointer' align=absmiddle></a>&nbsp;</TD>");
document.write("	</TR>");
document.write("	</TABLE>");
document.write("	</div>");
document.write("	<div style='padding:0px;background-color:#fff;'><div style='height:1px;'></div>");
document.write("		<iframe width=0 height=0 border=0 frameborder=0 src='' name='MessIframe2x' id='MessIframe2x'></iframe>");
document.write("	</div>");
document.write("</div>");
...
document.write("		<TD align=right style='padding-top:5px'><a href='javascript:CloseMess3();'><img src=/images/shengqing2_03.jpg border=0 style='cursor:pointer' align=absmiddle></a>&nbsp;</TD>");
document.write("	</TR>");
document.write("	</TABLE>");
document.write("	</div>");
...
function sc1(name){
 document.getElementById(name).style.top=(document.documentElement.scrollTop+(document.documentElement.clientHeight-document.getElementById(name).offsetHeight)/2)+"px";
