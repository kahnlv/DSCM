...
* ======================================================================== 
-->
<%@ Page Language="C#" AutoEventWireup="true" CodeFile="new_insert.aspx.cs" Inherits="Backstage_templates_default_new_insert" %>
...
<form id="mpostForm" name="mpostForm" action="/backstage/index.aspx?ds=new&cm=dsinsert" method="post" onsubmit="return sub()">
    <h3><span>新闻基本信息</span></h3>
     <ul class="forminfo">
      <li class=" mt10"><span>关键字：</span>
      <input type="text" name="new_key"  class="w340"/>
      </li>
      <li class=" mt10"><span>新闻标题：</span>
      <input type="text" name="new_title"  class="w340"/>
      </li>
      <li class=" mt10"><span>发布时间：</span>
      <input type="text" name="new_time"  id="new_time" class="w340"/>
      </li>
      ...
      <input type="text" name="new_label"  class="w340"/>
      </li>
      <li class=" mt10"><span>新闻描述：</span>
          <textarea style="width:600px;height:100px;" name="new_inc"></textarea>
      </li>
      <li class=" mt10"><span>新闻内容：</span>
          <textarea style="width:600px;height:300px;" name="new_doc"></textarea>
      </li>
      <li class=" mt10"><span>是否推荐：</span>
      <label><input type="radio" name="new_tuijian" value="1" id="Radio1" />是</label>
      <label><input type="radio" name="new_tuijian" value="0" id="Radio2" />否</label>
      </li>
