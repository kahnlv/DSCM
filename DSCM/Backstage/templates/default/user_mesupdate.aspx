...
* ======================================================================== 
-->
<%@ Page Language="C#" AutoEventWireup="true" CodeFile="user_mesupdate.aspx.cs" Inherits="Backstage_templates_default_user_mesupdate" %>
...
<form id="mpostForm" name="mpostForm" action="/backstage/index.aspx?ds=user&cm=dsphotocomupdate" method="post" onsubmit="return sub()">
    <h3><span>留言信息</span></h3>
     <ul class="forminfo">
          <li class=" mt10"><span>留言内容：</span>      
