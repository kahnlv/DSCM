...
* ======================================================================== 
-->
<%@ Page Language="C#" AutoEventWireup="true" CodeFile="user_meshuifu.aspx.cs" Inherits="Backstage_templates_default_user_meshuifu" %>
        ...
        <table>
           ...
           <% 
            ...
            <tr>
                ...
                <td class="bn tc">
                    <a href="/backstage/index.aspx?ds=user&cm=mesupdate&id=<%=tuser_mes.User_Message_Id %>">修改回复</a>
                    <a href="/backstage/index.aspx?ds=user&cm=dsmesdelete&id=<%=tuser_mes.User_Message_Id %>">删除回复</a>
                </td>
            </tr>
            <% }
                }
