...
* ======================================================================== 
-->
<%@ Page Language="C#" AutoEventWireup="true" CodeFile="user_photocomhuifu.aspx.cs" Inherits="Backstage_templates_default_user_photocomhuifu" %>
        ...
        <table>
           ...
           <% 
            ...
            <tr>
                ...
                <td class="bn tc">
                    <a href="/backstage/index.aspx?ds=user&cm=photocomupdate&id=<%=tuser_mes.User_Message_Id %>">修改回复</a>
