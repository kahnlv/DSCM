...
<%@ Page Language="C#" AutoEventWireup="true" CodeFile="adminupload.aspx.cs" Inherits="img_upload" %>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
<title></title>
...
%>
<!-- form start -->
<form id="mpostForm" name="mpostForm" action="/img/adminupload.aspx" method="post" enctype="multipart/form-data">
