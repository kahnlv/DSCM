...
* ======================================================================== 
* 
* Author：鼎燊文化传媒 Time：2015/4/23 15:16:30 
* File name：user_object 
* Version：V1.0.1
* Company: 鼎燊文化传媒 
...
<%@ Page Language="C#" AutoEventWireup="true" CodeFile="user_object.aspx.cs" Inherits="Reception_templates_default_user_object" %>
...
<div class="pmanage_main fR">
      ...
      <div class="pmanage_menu">
        <ul class="HeaeNavList">
          <li class="active"><a href="javascript:void(0)">发起项目</a></li>
