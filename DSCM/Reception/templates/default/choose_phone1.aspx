...
* ======================================================================== 
-->
<%@ Page Language="C#" AutoEventWireup="true" CodeFile="choose_phone1.aspx.cs" Inherits="Reception_templates_default_choose_phone1" %>
...
<div class="W1200 Mt98 ">
	<div class="find-password">
    	<h3>找回密码</h3>
        	...
        	<div class="findroot"><span class="fL wid">输入手机号：</span><input type="text" class="inputtext1"  /> <span class="current2">*手机号不存在</span></div>
       		...
       		<div class="findroot"><a href="<%=HTMLConfig.HTML_PATH_PAGE %>choose_phone2.aspx"><input type="submit" value="下一步" class="inputsubmit" /></a></div>
