<%@ Page Language="C#" AutoEventWireup="true" CodeFile="quanzi_arcinsert.aspx.cs" Inherits="Reception_templates_default_quanzi_arcinsert" ValidateRequest="false" %>
                        ...
                        <li class="clearfix">
                            ...
                            <FORM id="mpostForm" class="clearfix" method="post" name="mpostForm" action="">
                               <div  class="part_face fr" style="background: #fff;padding:10px;width:550px;" >
                                    <div  style="margin-bottom:5px;margin-left: 33px;">文章描述图
                            ...
                            <form id="qzmpostForm" name="qzmpostForm" action="/Reception/index.aspx?ds=quanzi&cm=dsarcinsert" method="post" onsubmit="">
						        <div class="part_con fr">
                                    <div class="part_bg"></div>
						        	<span>文章标题</span><h1 class="arc_title"><input type="text" id="arc_title" name="arc_title" style="width:350px;height:30px;"/></h1>
                                    <span>文章标签</span>
