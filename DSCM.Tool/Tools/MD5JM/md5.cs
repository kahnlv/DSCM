...
#region DES加密方法
        ...
        public string EncryptDES(string encryptString)
        {
            try
            {
                string encryptKey = PageConfig.Md5Str;
        ...
        public string DecryptDES(string decryptString)
        {
            try
            {
                string decryptKey = PageConfig.Md5Str;
...
#region 对称加密
        ...
        {
            string sTemp = PageConfig._DCKEY;
